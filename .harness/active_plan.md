...
**Status:** revised (rev 4) — council round 3 decision was **Proceed**; human approval received "with the refinements." This rev adds the two refinements explicitly so the next council run attests to them against the approved SHA. No implementation yet (Milestone 1 execution begins after council round 4 re-affirms).
